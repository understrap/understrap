...
function understrap_posted_on() {
	...
	$byline = sprintf(
		...
		'<span class="author vcard" itemprop="author editor publisher" itemscope itemtype="http://schema.org/Person"><a class="url fn n" href="' . esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ) . '" rel="me author" itemprop="url"><span itemprop="name">' . esc_html( get_the_author() ) . '</span></a></span>'
	);
