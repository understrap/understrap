...
function understrap_posted_on() {
	...
	$byline = sprintf(
		...
		'<span class="author vcard" itemprop="author" itemscope itemtype="http://schema.org/Person"><a class="url fn n" href="' . esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ) . '" rel="me author" itemprop="url">' . esc_html( get_the_author() ) . '</a></span>'
	);
