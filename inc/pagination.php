...
if ( ! function_exists( 'understrap_pagination' ) ) {
	function understrap_pagination( $args = [], $class = 'pagination' ) {
		...
		<nav aria-label="<?php echo esc_html( $args['screen_reader_text'] ); // WPCS: XSS ok. ?>">
			<ul class="pagination">
				<li class="page-item">
					<a class="page-link" href="<?php echo esc_attr( $prev_link ); ?>" aria-label="<?php esc_html_e( 'Previous', 'understrap' ); ?>">
				...
				<li class="page-item">
					<a class="page-link" href="<?php echo esc_attr( $next_link ); ?>" aria-label="<?php esc_html_e( 'Next', 'understrap' ); ?>">
