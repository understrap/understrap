<?php
/**
 * Widget API: BS_Widget_Custom_HTML class
 *
 * @package befluid
 * @subpackage Widgets
 * @since 4.8.1
 ...
 * @see WP_Widget
 */
class BS_Widget_Custom_HTML extends WP_Widget {
	...
	public function _register_one( $number = -1 ) {
		...
		add_action( 'admin_footer-widgets.php', array( 'BS_Widget_Custom_HTML', 'render_control_template_scripts' ) );

		// Note this action is used to ensure the help text is added to the end.
		add_action( 'admin_head-widgets.php', array( 'BS_Widget_Custom_HTML', 'add_help_text' ) );
	}
	...
	public function widget( $args, $instance ) {
		 ...
		 * @param BS_Widget_Custom_HTML $this     Current Custom HTML widget instance.
		 */
	 ...
	 *
	 * @since 4.8.1
	 * @since 4.9.0 The form contains only hidden sync inputs. For the control UI, see `BS_Widget_Custom_HTML::render_control_template_scripts()`.
	 *
	 * @see BS_Widget_Custom_HTML::render_control_template_scripts()
