 ...
 * @see WP_Widget
 */
abstract class BS_Widget_Media extends WP_Widget {
	...
	public function get_instance_schema() {
		 ...
		 * @param BS_Widget_Media $this   Widget object.
		 */
	 ...
	 * @since 4.8.0
	 *
	 * @see \BS_Widget_Media::render_control_template_scripts() Where the JS template is located.
