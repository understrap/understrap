<?php
/**
 * Widget API: BS_Widget_Text class
 *
 * @package befluid
 * @subpackage Widgets
 * @since 4.4.0
 ...
 * @see WP_Widget
 */
class BS_Widget_Text extends WP_Widget {
	...
	public function _register_one( $number = -1 ) {
		...
		add_action( 'admin_footer-widgets.php', array( 'BS_Widget_Text', 'render_control_template_scripts' ) );
	}
	...
	public function widget( $args, $instance ) {
		 ...
		 * @since 4.8.1 The `$this` param may now be a `BS_Widget_Custom_HTML` object in addition to a `BS_Widget_Text` object.
		 *
		 * @param string                               $text     The widget content.
		 * @param array                                $instance Array of settings for the current widget.
		 * @param BS_Widget_Text|BS_Widget_Custom_HTML $this     Current Text widget instance.
		 */
		...
		if ( $is_visual_text_widget ) {
			 ...
			 * @param string         $text     The widget content.
			 * @param array          $instance Array of settings for the current widget.
			 * @param BS_Widget_Text $this     Current Text widget instance.
			 */
	 ...
	 * @since 4.9.0
	 *
	 * @see BS_Widget_Media_Video::inject_video_max_width_style()
	 ...
	 * @see BS_Widget_Visual_Text::render_control_template_scripts()
